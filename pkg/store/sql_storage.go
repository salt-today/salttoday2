...
import (
	...
	"github.com/salt-today/salttoday2/pkg/store/migrations"
...
func (s *sqlStorage) GetComments(ctx context.Context, opts CommentQueryOptions) ([]*Comment, error) {
	...
	for rows.Next() {
		...
		comments = append(comments, &Comment{
			ID:       id,
			Article:  Article{ID: articleID, Title: articleTitle, Url: articleUrl},
...
func (s *sqlStorage) GetUserByID(ctx context.Context, id int) (*User, error) {
